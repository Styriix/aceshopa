    ...
    <div class="container main_body"> <div class="section" >
      <div class="column is-6 is-offset-3">
        ...
        <div class="box">
          ...
          $msg = 'successfully check and ready to instal';
...
$config["base_url"] = "'.$base.'";', FILE_APPEND | LOCK_EX);
          ...
          <p>
          	Admin Username: admin@dvs.com<br>
          	Admin Password: 12345678<br><br>

          	Sub Admin Username: subadmin@dvs.com<br>
          	Sub Admin Password: 12345678<br><br>
          </p>
			<center><a href="https://cutt.ly/0wd92hu" target="_blank">Support</a></center>
          </center>
          <?php
          }
          else
